...
- В настройках появился выбор **«Куда вставлять»**: «в окно, активное на момент завершения записи» (по умолчанию — прежнее поведение) или «в окно, активное на момент начала записи». Второй режим защищает от случайной смены фокуса: если к моменту готовности текста активно другое окно, вставка не выполняется, а текст остаётся в буфере обмена и показывается в плашке.
